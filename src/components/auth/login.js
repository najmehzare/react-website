...
import { setAuth } from "../../store/slices/globalSlice";
    ...
    let formHandler = async (e) => {
        ...
        try {
            ...
            if(res) {
                ...
                setError("کاربری با اطلاعات وارد شده وجود ندارد");
                console.log(e);
            }            
        } catch (e) {
        ...
        <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl md:max-w-xl">
                ...
                <p className="mt-8 text-xs font-light text-center text-gray-700">
                    {" "}
                   تبت نام نکرده اید؟{" "}
                   <NavLink to="/admin/register">ثبت نام</NavLink>
                </p>
            </div>
        </div>
    );
